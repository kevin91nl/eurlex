...
The dependency graph below is generated by [`import-cruiser`](https://github.com/kevin91nl/import-cruiser) and refreshed by the pre-commit hook. It focuses on `src/eurlex` and its non-dev external dependencies, while keeping the current public import surface available through `eurlex`.
